...
ClapTrap::ClapTrap(int m_hitpoints, int m_energyPoints, int m_attackDamage, std::string m_name) {
    std::cout << "Сonstructor overloaded ClapTrap" << std::endl;
    this->name = m_name;
    this->hitpoints = m_hitpoints;
    this->attackDamage = m_attackDamage;
    this->energyPoints = m_energyPoints;
}
