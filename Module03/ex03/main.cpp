...
int	main()
{
    ...
    std::cout << "________________" << std::endl;
    DiamondTrap robot_5_1("Kulim");
    DiamondTrap robot_5_2;
    DiamondTrap robot_5_3("Teres");
    robot_5_3 = robot_5_1;
    robot_5.attack("Aqua");
    robot_5.takeDamage(23);
    robot_5.beRepaired(41);
    robot_5.highFivesGuys();
